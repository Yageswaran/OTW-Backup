...
public class HelloFacebookSampleActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		suka = (Button) findViewById(R.id.button1);
		suka.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				//onClickPickPlace();
				
				Toast.makeText(getApplicationContext(), "Suka Tak Suka Selectedd", 
	...
	private FacebookDialog.ShareDialogBuilder createShareDialogBuilderForLink() {
		return new FacebookDialog.ShareDialogBuilder(this).setName("Testing")
				.setDescription("App Testing")
